...
const AddEmployee = () => {
    ...
    const handleSubmit = async (values) => {
        ...
        try {
            ...
            // Map form fields to Employee model fields
            const employeeData = {
            ...
            if (response.data.success) {
                ...
                console.error('❌ Error saving employee:', response.data);
            }
        } catch (error) {
            const errorMessage = error.response?.data?.message || error.response?.data?.error || 'Failed to add employee. Please try again.';
        ...
        <>
            ...
            >
                ...
                >
                    ...
                    >
                        <TextArea 
                            placeholder="Any special notes or preferences about the employee"
                            rows={3}
                            size="large"
                        />
                    </Form.Item>
